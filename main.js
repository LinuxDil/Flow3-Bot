...
// Fungsi untuk format waktu yang lebih rapi
...
const runLoop = async () => {
    ...
    while (true) {
        ...
        if (bandwidth && points) {
            console.log(`
\x1b[34m============= Flow3 Network Bot =============\x1b[0m
...
`);
        ...
        console.log("Menunggu 10 detik sebelum request berikutnya...\n");
